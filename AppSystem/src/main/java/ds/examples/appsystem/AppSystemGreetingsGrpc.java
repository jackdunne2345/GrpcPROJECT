...
public final class AppSystemGreetingsGrpc {
  ...
  public static final String SERVICE_NAME = "appsystem.AppSystemGreetings";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ds.examples.appsystem.HeatRequest,
      ds.examples.appsystem.HeatReply> getAppMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "app",
  ...
  public static io.grpc.MethodDescriptor<ds.examples.appsystem.HeatRequest,
      ds.examples.appsystem.HeatReply> getAppMethod() {
    io.grpc.MethodDescriptor<ds.examples.appsystem.HeatRequest, ds.examples.appsystem.HeatReply> getAppMethod;
    if ((getAppMethod = AppSystemGreetingsGrpc.getAppMethod) == null) {
      synchronized (AppSystemGreetingsGrpc.class) {
        if ((getAppMethod = AppSystemGreetingsGrpc.getAppMethod) == null) {
          AppSystemGreetingsGrpc.getAppMethod = getAppMethod = 
              io.grpc.MethodDescriptor.<ds.examples.appsystem.HeatRequest, ds.examples.appsystem.HeatReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "appsystem.AppSystemGreetings", "app"))
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new AppSystemGreetingsMethodDescriptorSupplier("app"))
                  .build();
          }
        }
     }
  ...
  public static abstract class AppSystemGreetingsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void app(ds.examples.appsystem.HeatRequest request,
        io.grpc.stub.StreamObserver<ds.examples.appsystem.HeatReply> responseObserver) {
      asyncUnimplementedUnaryCall(getAppMethod(), responseObserver);
    }
  ...
  public static final class AppSystemGreetingsStub extends io.grpc.stub.AbstractStub<AppSystemGreetingsStub> {
    ...
    public void app(ds.examples.appsystem.HeatRequest request,
        io.grpc.stub.StreamObserver<ds.examples.appsystem.HeatReply> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getAppMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AppSystemGreetingsBlockingStub extends io.grpc.stub.AbstractStub<AppSystemGreetingsBlockingStub> {
    ...
    /**
     */
    public ds.examples.appsystem.HeatReply app(ds.examples.appsystem.HeatRequest request) {
      return blockingUnaryCall(
          getChannel(), getAppMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class AppSystemGreetingsFutureStub extends io.grpc.stub.AbstractStub<AppSystemGreetingsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ds.examples.appsystem.HeatReply> app(
        ds.examples.appsystem.HeatRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getAppMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_APP = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_APP:
          serviceImpl.app((ds.examples.appsystem.HeatRequest) request,
              (io.grpc.stub.StreamObserver<ds.examples.appsystem.HeatReply>) responseObserver);
          break;
        default:
